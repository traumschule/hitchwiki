...
apt-get -y autoclean
if [ -d /var/www/public/tor ] ; then
  cd /var/www/public/tor; make uninstall
fi
echo "Removing $PATHS"
rm -fr $PATHS
deluser $USER
